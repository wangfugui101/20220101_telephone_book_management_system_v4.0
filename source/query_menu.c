...
void CheckedByName(PNODE pHead)
{
    ...
    if(pHead == NULL){
        ...
        printf(DEFAULT_MODE FONT_HIGHLIGHT_GREEN "请输入你要查询联系人的姓名："DEFAULT_MODE);
        scanf("%s",pos);
...
void CheckedByPhone(PNODE pHead)
{
    ...
    if(pHead == NULL){
        ...
        printf(DEFAULT_MODE FONT_HIGHLIGHT_GREEN "请输入你要查询联系人的电话号码："DEFAULT_MODE);
        scanf("%s",pos);
...
void query_menu(PNODE pHead)
{
    while(1){
        ...
        printf(DEFAULT_MODE FONT_HIGHLIGHT_GREEN"          欢迎来到查询联系人子系统          \n"DEFAULT_MODE);
        printf(DEFAULT_MODE BLINK FONT_HIGHLIGHT_RED "********************************************\n"DEFAULT_MODE);
        printf(DEFAULT_MODE FONT_HIGHLIGHT_GREEN"1--按照联系人姓名查询       2--按照联系人电话号码查询\n"DEFAULT_MODE);
